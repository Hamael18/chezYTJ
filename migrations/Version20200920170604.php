 ...
 */
final class Version20200920170604 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Add relation between user and book in order to create libraries';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_book ADD CONSTRAINT FK_B164EFF816A2B381 FOREIGN KEY (book_id) REFERENCES books (id) ON DELETE CASCADE');
    }
